...
<main role="main" class="container">
    ...
    <div class=" p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Meeting Rooms </h6>
        ...
        <div class="media text-muted pt-3">
            ...
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <strong class="text-gray-dark">Mind and Body 12/2/22</strong>
                    <a href="?prefix=group_therapy_sms&page=pages%2Fchat&pid=16">View</a>
                </div>
                <span class="d-block">Donec id elit non mi porta gravida at eget metus. Fusce dapibus ...</span>
            </div>
...
<!--            <h6 class="border-bottom border-gray pb-2 mb-0">Chat Sessions (DISABLED)</h6>-->
<!--            <div class="media text-muted pt-3">-->
...
<!--                        <strong class="d-block text-gray-dark">Miscellaneous topics</strong>-->
<!--                        <a href="?prefix=group_therapy_sms&page=pages%2Fchat&pid=16">View</a>-->
<!--                    </div>-->
...
<!--                    <strong class="d-block text-gray-dark">Health Checkup 2/10/22</strong>-->
...
<!--                <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">-->
<!--                    <strong class="d-block text-gray-dark">Activity & More</strong>-->
<!--                    Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.-->
<!--                </p>-->
<!--            </div>-->
<!--            <div class="media text-muted pt-3">-->
<!--                <img data-src="holder.js/32x32?theme=thumb&amp;bg=6f42c1&amp;fg=6f42c1&amp;size=1" alt="32x32" class="mr-2 rounded" src="data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2232%22%20height%3D%2232%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_184caff222c%20text%20%7B%20fill%3A%236f42c1%3Bfont-weight%3Abold%3Bfont-family%3AArial%2C%20Helvetica%2C%20Open%20Sans%2C%20sans-serif%2C%20monospace%3Bfont-size%3A2pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_184caff222c%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%236f42c1%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%2212.296875%22%20y%3D%2216.9%22%3E32x32%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E" data-holder-rendered="true" style="width: 32px; height: 32px;">-->
<!--                <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">-->
<!--                    <strong class="d-block text-gray-dark">Statistics</strong>-->
<!--                    Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.-->
<!--                </p>-->
<!--            </div>-->
<!--            <small class="d-block text-right mt-3">-->
